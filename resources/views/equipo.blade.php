...
<div class="max-w-7xl mx-auto px-4 py-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden relative hover:bg-gradient-to-r hover:from-[#ebb630] hover:to-[#ffe435f6]">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden relative hover:bg-gradient-to-r hover:from-[#ebb630] hover:to-[#ffe435f6]">
            ...
            <div class="p-5">
                <h2 class="text-xl font-semibold text-slate-800 mb-2">Enterito</h2>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden relative hover:bg-gradient-to-r hover:from-[#ebb630] hover:to-[#ffe435f6]">
            <img src="https://images.unsplash.com/photo-1622314901629-e2d6f520fdd2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Guantes de moto" class="w-full h-48 object-cover">
            <div class="p-5">
                <h2 class="text-xl font-semibold text-slate-800 mb-2">Anteojos</h2>
                <p class="text-slate-600">Guantes deportivos con protección rígida y agarre antideslizante.</p>
            </div>
        </div>
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden relative hover:bg-gradient-to-r hover:from-[#ebb630] hover:to-[#ffe435f6]">
            <img src="https://images.unsplash.com/photo-1622314901629-e2d6f520fdd2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Guantes de moto" class="w-full h-48 object-cover">
            <div class="p-5">
                <h2 class="text-xl font-semibold text-slate-800 mb-2">Rodilleras</h2>
                <p class="text-slate-600">Guantes deportivos con protección rígida y agarre antideslizante.</p>
            </div>
        </div>
    </div>
